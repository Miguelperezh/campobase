...
import './exercise-board-persistence.js?v=20260919-prod-current-v15';
import './runtime-refresh.js?v=20260919-prod-current-v15';
import './exercise-viewer-controls.js?v=2475';
import './exercise-viewer-layout.js?v=2475';
import './exercise-view-mode-ui.js?v=20260919-prod-current-v15';
...
export function createCampoBaseCloudStore() {
  ...
  void import('./saas-session-guard.js?v=1')
    ...
    .then(() => import('./saas-auth-ui-v2.js?v=20260919-prod-current-v15'))
