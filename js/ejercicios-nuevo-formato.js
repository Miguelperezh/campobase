...
function normalizeNewExercise(exercise) {
  ...
  return {
    ...
    // Los URLs de preview y MP4 gráfico generados en la primera integración apuntaban
    // a objetos que no existen. Se conserva la referencia original para trazabilidad,
    // pero la UI usa el vídeo humano existente y el placeholder validado hasta que
    // el asset gráfico esté realmente publicado, evitando imágenes/reproductores rotos.
    media: {
      ...originalMedia,
      preview: '',
