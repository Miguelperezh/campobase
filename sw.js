...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260919-prod-current-v8', './styles-redesign.css', './styles-redesign.css?v=20260919-prod-current-v8', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
