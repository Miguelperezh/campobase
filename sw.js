...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260925-v61-equipo-nav-persistence', './styles-redesign.css', './styles-redesign.css?v=20260925-v61-equipo-nav-persistence', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
