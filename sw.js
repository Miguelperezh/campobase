...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260924-v56-delegate-save-perms-clean-nav-fix', './styles-redesign.css', './styles-redesign.css?v=20260924-v56-delegate-save-perms-clean-nav-fix', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
