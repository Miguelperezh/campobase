...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260923-v49-delegate-pin-mobile-print-fix', './styles-redesign.css', './styles-redesign.css?v=20260923-v49-delegate-pin-mobile-print-fix', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
