const CACHE = 'campobase-v2.44.0-player-sync-attendance-2453-responsive-2455-today-2456-sessiontop-2458-sessionplanner-2461-exerciseboard-2475-themev12-v2-248-fullscreen-dates-playfix-duration-2502-whatsapp-web-f7-50-v2522-modo-campo-tema-ejercicios';
const BOARD_PARTS = [
...
const ASSETS = [
  ...
  './modo-campo-directo.html', './modo-campo-directo.css', './modo-campo-directo.css?v=4', './modo-campo-theme.css', './modo-campo-theme.css?v=1',
  ...
  './js/modo-campo-directo.js', './js/modo-campo-directo.js?v=4', './js/modo-campo-identity-exercises.js', './js/modo-campo-identity-exercises.js?v=1', './js/modo-campo-actions.js', './js/modo-campo-actions.js?v=1', './js/modo-campo-integration.js', './js/modo-campo-integration.js?v=1',
