...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260924-v57-delegate-dynamic-permissions-persist-fix', './styles-redesign.css', './styles-redesign.css?v=20260924-v57-delegate-dynamic-permissions-persist-fix', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
