...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260924-v52-delegate-permissions-reparto-visual-mobile-pdf', './styles-redesign.css', './styles-redesign.css?v=20260924-v52-delegate-permissions-reparto-visual-mobile-pdf', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
