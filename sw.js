...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260924-v51-delegate-live-realtime-pdf-mobile', './styles-redesign.css', './styles-redesign.css?v=20260924-v51-delegate-live-realtime-pdf-mobile', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
