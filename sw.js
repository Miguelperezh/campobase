...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=20260924-v50-inter-pilar-live-mobile-pdf-export', './styles-redesign.css', './styles-redesign.css?v=20260924-v50-inter-pilar-live-mobile-pdf-export', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
