const CACHE = 'campobase-v2.7.0';
const ASSETS = [
  './', './index.html', './styles.css', './manifest.webmanifest',
  './js/app.js', './js/db.js', './js/domain.js', './js/training-domain.js', './js/real-exercises.js', './js/exercise-planning.js', './js/sync-core.js', './js/supabase-client.js',
  './vendor/supabase.js',
