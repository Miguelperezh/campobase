const CACHE = 'campobase-v2.44.0-player-sync-attendance-2453-responsive-2455-today-2456-sessiontop-2458-sessionplanner-2461-exerciseboard-2475-themev12-v2-248-fullscreen-dates-playfix-duration-2502-whatsapp-web-f7-50-v2528-exercise-content-audit-mirror-materials-orientation-session-audit-copy-hotfix-badge-cleanup-pwa-install-v2-250917-promo-roster-1-saas-auth-v3-attendance-manual-v4-exercises-hotfix-v2-auth-recovery-v1-player-profile-guard-v1-exercise-media-filter-v2-derived-stats-link-v1-manual-player-profile-v1-exercise-cover-humanvideo-hotfix-20260918-billing-v1-team-delegate-v1-visible-plans-delegate-v1-plans-before-register-v1-strict-access-visual-v1-plans-clean-layout-v1-registration-trial-payment-v1-trial-counter-settings-v1-billing-preview-v1-theme-linked-billing-v1-preview-separated-v1';
const BOARD_PARTS = [
...
const ASSETS = [
  './', './index.html', './styles.css', './styles.css?v=2502', './styles-redesign.css', './styles-redesign.css?v=2502', './billing.css', './billing.css?v=1', './manifest.webmanifest', './pwa-install.css', './pwa-install.css?v=2',
