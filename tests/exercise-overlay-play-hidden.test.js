...
test('versión de caché en sw.js e index.html están sincronizadas a v=20260922-releases-mobile-all-v37', () => {
  const sw = fs.readFileSync('sw.js', 'utf8');
  const html = fs.readFileSync('index.html', 'utf8');

  assert.match(sw, /2503/, 'sw.js debe contener la versión 2503');
  assert.match(html, /styles-redesign\.css\?v=20260922-releases-mobile-all-v37/, 'index.html debe cargar styles-redesign.css con v=20260922-releases-mobile-all-v37');
  assert.match(html, /js\/app\.js\?v=20260922-releases-mobile-all-v37/, 'index.html debe cargar js/app.js con v=20260922-releases-mobile-all-v37');
});
