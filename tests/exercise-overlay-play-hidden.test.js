...
test('versión de caché en sw.js e index.html están sincronizadas a v=2491', () => {
  const sw = fs.readFileSync('sw.js', 'utf8');
  const html = fs.readFileSync('index.html', 'utf8');

  assert.match(sw, /2491/, 'sw.js debe contener la versión 2491');
  assert.match(html, /styles-redesign\.css\?v=2491/, 'index.html debe cargar styles-redesign.css con v=2491');
  assert.match(html, /js\/app\.js\?v=2491/, 'index.html debe cargar js/app.js con v=2491');
});
