...
test('versión de caché en sw.js e index.html están sincronizadas a v=20260925-v60-equipo-prep-persistence', () => {
  const sw = fs.readFileSync('sw.js', 'utf8');
  const html = fs.readFileSync('index.html', 'utf8');

  assert.match(sw, /2503/, 'sw.js debe contener la versión 2503');
  assert.match(html, /styles-redesign\.css\?v=20260925-v60-equipo-prep-persistence/, 'index.html debe cargar styles-redesign.css con v=20260925-v60-equipo-prep-persistence');
  assert.match(html, /js\/app\.js\?v=20260925-v60-equipo-prep-persistence/, 'index.html debe cargar app.js con el cache-bust de convocatorias amistosas');
});
