...
test('2475 publica solo la corrección del visor y mantiene la integración validada', () => {
  ...
  assert.match(supabaseClient, /exercise-board-persistence\.js\?v=20260922-mobile-video-f7-126-v34/);
  assert.match(supabaseClient, /runtime-refresh\.js\?v=20260922-mobile-video-f7-126-v34/);
