...
test('2475 publica solo la corrección del visor y mantiene la integración validada', () => {
  ...
  assert.match(supabaseClient, /exercise-board-persistence\.js\?v=20260924-v57-delegate-dynamic-permissions-persist-fix/);
  assert.match(supabaseClient, /runtime-refresh\.js\?v=20260924-v57-delegate-dynamic-permissions-persist-fix/);
