...
test('sw.js e index.html están sincronizados a v=20260925-v63-live-lineup-persist', () => {
  assert.match(sw, /duration-2503/, 'sw.js debe tener la clave de caché con 2503');
  assert.match(html, /styles-redesign\.css\?v=20260925-v63-live-lineup-persist/, 'index.html debe cargar estilos con v=20260925-v63-live-lineup-persist');
  assert.match(html, /js\/app\.js\?v=20260925-v63-live-lineup-persist/, 'index.html debe cargar app.js con v=20260925-v63-live-lineup-persist');
});
