...
test('sw.js e index.html están sincronizados a v=20260925-v60-equipo-prep-persistence', () => {
  assert.match(sw, /duration-2503/, 'sw.js debe tener la clave de caché con 2503');
  assert.match(html, /styles-redesign\.css\?v=20260925-v60-equipo-prep-persistence/, 'index.html debe cargar estilos con v=20260925-v60-equipo-prep-persistence');
