...
test('build v15 está alineado en HTML, app, sesión, auth cloud y service worker', () => {
  const build = '20260919-prod-current-v15';
  ...
  assert.match(demo, /session-planner-ui\.js\?v=20260919-prod-current-v15/);
});
