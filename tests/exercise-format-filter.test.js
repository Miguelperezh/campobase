...
test('el catálogo conserva los 298 históricos y antepone los 12 ejercicios actuales respetando su F7/F11 original', () => {
...
test('filtrado por formato respeta el F7/F11 original de los 12 ejercicios actuales', () => {
  ...
  assert.equal(f11Filtered.length, 257, '248 históricos F11 + 9 actuales F11');
  ...
  assert.equal(f7Filtered.length, 53, '50 históricos F7 + 3 actuales F7');
