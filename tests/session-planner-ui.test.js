...
test('el planificador y la PWA cargan la misma revisión actual', () => {
  assert.match(demo, /session-planner-ui\.js\?v=20260923-stats-setpieces-modocampo-v45/);
  assert.match(sw, /20260923-stats-setpieces-modocampo-v45/);
  assert.match(sw, /session-planner-ui\.js\?v=20260923-stats-setpieces-modocampo-v45/);
