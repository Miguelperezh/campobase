...
test('el planificador y la PWA cargan la misma revisión actual', () => {
  assert.match(demo, /session-planner-ui\.js\?v=20260922-mobile-library-v37/);
  assert.match(sw, /20260922-mobile-library-v37/);
  assert.match(sw, /session-planner-ui\.js\?v=20260922-mobile-library-v37/);
