...
test('el planificador y la PWA cargan la misma revisión actual', () => {
  assert.match(demo, /session-planner-ui\.js\?v=20260924-v58-delegate-sync-permissions-final-fix/);
  assert.match(sw, /20260924-v58-delegate-sync-permissions-final-fix/);
  assert.match(sw, /session-planner-ui\.js\?v=20260924-v58-delegate-sync-permissions-final-fix/);
