...
test('el planificador y la PWA cargan la misma revisión actual', () => {
  ...
  assert.match(sw, /20260924-v53-delegate-team-invite-layout-freeze-fix/);
  assert.match(sw, /session-planner-ui\.js\?v=20260924-v53-delegate-team-invite-layout-freeze-fix/);
