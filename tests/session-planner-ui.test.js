...
test('el planificador y la PWA cargan la misma revisión actual', () => {
  assert.match(demo, /session-planner-ui\.js\?v=20260923-v47-compact-print-export/);
  assert.match(sw, /20260923-v47-compact-print-export/);
  assert.match(sw, /session-planner-ui\.js\?v=20260923-v47-compact-print-export/);
