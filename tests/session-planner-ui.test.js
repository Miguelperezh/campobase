...
test('el planificador y la PWA cargan la misma revisión actual', () => {
  assert.match(demo, /session-planner-ui\.js\?v=20260925-v60-equipo-prep-persistence/);
  assert.match(sw, /20260925-v60-equipo-prep-persistence/);
  assert.match(sw, /session-planner-ui\.js\?v=20260925-v60-equipo-prep-persistence/);
